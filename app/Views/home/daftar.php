...
<div class="container mt-90">
    <form class="pt-60" method="post" action="/save-daftar">
        <?= csrf_field(); ?>
        ...
        <div data-mdb-input-init class="input-group">
            ...
            <input type="date" name="tgl_daftar" id="form6Example3" class="form-control" />
        </div>
        ...
        <div data-mdb-input-init class="input-group">
            ...
            <input type="text" name="kasus" id="form6Example6" class="form-control" />
        </div>

        <div data-mdb-input-init class="input-group">
            <input type="hidden" name="biaya" value="0" id="form6Example6" class="form-control" />
        </div>
