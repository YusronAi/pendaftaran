...
<head>
    ...
    <?= $this->include("template/head.php"); ?>
    <title><?= $title; ?></title>
</head>
                                    ...
                                    <form method="post" action="/register" class="px-md-2" enctype="multipart/form-data">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="text" id="form3Example3c" class="form-control" name="password" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <input type="number" id="form3Example4c" class="form-control" name="no_telephone" />
                                            </div>
                                        </div>
