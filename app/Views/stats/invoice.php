...
<table cellpadding="0" >
    <tr>
        <th width="10%">Nama</th>
        <th width="40%">: <strong><?= $daftar['nama_pasien']; ?></strong></th>
        <th width="10%">Sales</th>
        <th width="40%">: <strong><?= $daftar['nama_poli']; ?></strong></th>
    </tr>
    <tr>
...
<table id="tb-item" cellpadding="4" >
    ...
    <tr>
        <td style="height: 20px">Pendaftaran</td>
...
<p>BCA: IDR<br/>A/C : 164-800-3325<br/>A/N : RS PERMATA</p>
<p>&nbsp;</p>
<table cellpadding="4" >
    <tr>
